...
## Diagrams
### Arduino Nano
![Nano Diagram](nano_7.png)
Step-by-step diagrams

**Step 1 – Components needed**
![Step 1 - Components needed](nano_1.png)

**Step 2 – Place components on the breadboard**
![Step 2 - Components on breadboard](nano_2.png)

**Step 3 – Connect 5V to the right leg of the push button**
![Step 3 - 5V to push button](nano_3.png)

**Step 4 – Connect GND to the left of the 10kΩ resistor on the push button**
![Step 4 - GND to 10k resistor](nano_4.png)

**Step 5 – Connect Pin 2 to the left leg of the push button**
![Step 5 - Pin 2 to push button](nano_5.png)

**Step 6 – Connect GND to the negative leg of the LED**
![Step 6 - GND to LED](nano_6.png)

**Step 7 – Connect Pin 3 to the 220Ω resistor on the positive leg of the LED**
![Step 7 - Pin 3 to LED resistor](nano_7.png)
...
Note: We are keeping 10k resistor on pushbutton for stability.
